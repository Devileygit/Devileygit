                  ...
                  Stack(
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: NetworkImage(userDoc['profilePhoto']),
                                fit: BoxFit.cover,
                                alignment: Alignment.center)),
                        child: Padding(
                      ...
                      Container(
                        ...
                        child: SafeArea(
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.pop(context, ProfileEdit());
                            },
                          ),
                        ),
                      )
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProfileLocationEdit()));
                    },
                    child: Card(
                      margin: EdgeInsets.only(top: 15, left: 10, right: 10),
                      elevation: 4,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProfileAboutEdit()));
                    },
                    child: Card(
                      margin: EdgeInsets.only(top: 15, left: 10, right: 10),
                      elevation: 4,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProfileMaritalEdit()));
                    },
                    child: Card(
                      margin: EdgeInsets.only(top: 15, left: 10, right: 10),
                      elevation: 4,
                      ...
                      child: Column(
                        children: <Widget>[
                          editDetails('Relationship Status', userDoc['marital'])
                        ],
                      ),
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProfileAddictionEdit()));
                    },
                    child: Card(
                      margin: EdgeInsets.only(top: 15, left: 10, right: 10),
                      elevation: 4,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProfileOrientationEdit()));
                    },
                    child: Card(
                      margin: EdgeInsets.only(top: 15, left: 10, right: 10),
                      elevation: 4,
                      ...
                      child: Column(
                        children: <Widget>[
                          editDetails(
                              'Attraction Towards', userDoc['orientation'])
                        ],
                      ),
                    ),
                  ),
