...
class _ProfileLocationManualEditState extends State<ProfileLocationManualEdit> {
  ...
  final GlobalKey dropdownKey4 = GlobalKey();
  ...
  void simulateClick() {
    Timer(Duration(milliseconds: 200), () {
      custom.CustomDropdownButtonState state = dropdownKey3.currentState;
      state.callTap();
    });
  }
  ...
  void simulateClick2() {
    Timer(Duration(milliseconds: 100), () {
      custom.CustomDropdownButtonState state = dropdownKey4.currentState;
      state.callTap();
    });
  }
