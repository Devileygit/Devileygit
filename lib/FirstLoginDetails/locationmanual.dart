...
class _LocationManualDetailsState extends State<LocationManualDetails> {
  ...
  List<custom.DropdownMenuItem<Countries>> buildDropdownMenuItemsCountry(List countries) {
  ...
  List<custom.DropdownMenuItem<Cities>> buildDropdownMenuItemsCity(List cities){
                ...
                child: Container(
                  height: 70,
                    ...
                    child: Padding(
                      ...
                      child: cityName==null?(custom.CustomDropdownButtonHideUnderline(
                        child: _selectedCountry==null?custom.CustomDropdownButton(
                      ...
                      InkWell(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Center(child: Text(cityName,style: TextStyle(fontSize: 16),)),
                            Align(
