                        ...
                        children: <Widget>[
                          Container(
                              child: Stack(
                                ...
                                children: <Widget>[
                                  CircleAvatar(backgroundImage: NetworkImage(chatUserDoc['profilePhoto']),radius: 30,),
                                  FaIcon(FontAwesomeIcons.solidCircle,size: 15,color: Colors.green,)
                                ],
                              )
                          ),
                          SizedBox(width: 10,),
                          Flexible(
                            child: Column(
                              ...
                              children: <Widget>[
                                Text(chatUserDoc['name'],style: TextStyle(fontSize: 17),),
                                Container(
                                    child: Text(
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              Text('12:43 PM'),
                              FaIcon(FontAwesomeIcons.solidCircle,size: 15,color: Colors.pink[600],)
                            ],
                          )
                        ],
                      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.pink[50],
        elevation: 0,
        title: Text('Messages', style: TextStyle(color: Colors.grey[800],fontWeight: FontWeight.bold),),
        actions: <Widget>[
          IconButton(
