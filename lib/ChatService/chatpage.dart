...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({Key key, @required this.chatRoomId,@required this.snapShot}) : super(key: key);
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context,index){
                  return Messages(
                    ...
                    sendByMe: myUserId==snapshot.data.documents[index].data['sendBy'],
        ...
        title: PreferredSize(
          ...
          child: Container(
            child: GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder:(context)=> PeerProfile(snapShot: widget.snapShot,)));
              },
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: <Widget>[
                  CircleAvatar(backgroundImage:NetworkImage(widget.snapShot['profilePhoto']),radius: 18,),
                  SizedBox(width: 5,),
      ...
      body: CustomPaint(
        ...
        child: Container(
          child: Column(
            ...
            children: <Widget>[
              Container(
                  child: Expanded(child: chatMessages())),
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    IconButton(
                      icon: FaIcon(FontAwesomeIcons.solidSmile,color: Colors.pink[600],),
                      onPressed: (){},
                    ),
                    Expanded(
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding: EdgeInsets.only(left: 30,right: 30,top: 12,bottom: 10),
                    ...
                    IconButton(
                      icon: FaIcon(FontAwesomeIcons.solidPaperPlane,color: Colors.pink[600],),
...
class Messages extends StatelessWidget {
  ...
  const Messages({Key key, @required this.message, @required this.sendByMe,@required this.time})
      : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(DateFormat('jm').format(DateTime.fromMillisecondsSinceEpoch(int.parse(time))),style: TextStyle(color: Colors.grey[500],fontSize: 12),),
        ],
      ),
    );
  }
